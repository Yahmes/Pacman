...
class GameScene: SKScene {
    ...
    override func update(_ currentTime: TimeInterval) {
        func moveUp(character: SKSpriteNode, texture: String, tile: CGPoint) -> CGPoint{
            temp = tile
            for Check1 in superArrayPoisition - 26...superArrayPoisition + 26 {
        ...
        func moveDown(character: SKSpriteNode, texture: String, tile: CGPoint) -> CGPoint{
            temp = tile
            for Check2 in superArrayPoisition - 26...superArrayPoisition + 26 {
        ...
        func moveLeft(character: SKSpriteNode, texture: String, tile: CGPoint) -> CGPoint{
            temp = tile
            if CGPoint(x: allowedTiles[superArrayPoisition - 1].x ,y: allowedTiles[superArrayPoisition - 1].y) == CGPoint(x: temp.x - 1 ,y: temp.y) {
                temp.x -= 1
